...
<img src="docs/assets/synapse-logo.png" alt="SYNAPSE Logo" width="1500">
...
Design documents live in `docs/` (LaTeX sources and rendered PDFs):

- **01_SRS**: Software requirements specification
- **02_Architecture_Design**: System architecture
- **03_Database_Schema**: Data model
- **06_Implementation_Guide**: Implementation notes
- **08_DevOps_Deployment**: Deployment design
- **10_Testing_Strategy**: Test approach
