...
class SynapseRAGChain:
    ...
    def _build_llm(
        ...
        QA-24: Delegates to the shared ai_engine.agents.llm_factory.
        Uses build_llm_with_fallbacks so a rate-limited provider fails over to
        the next configured one instead of failing the request.
