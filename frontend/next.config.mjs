...
const nextConfig = {
  // Tell Turbopack the correct root so it compiles against the frontend dir,
  // not the monorepo root (which causes 17-minute compilation times).
  turbopack: {
    root: __dirname,
  },
  // Allow cross-origin requests from Replit dev preview domains
  allowedDevOrigins: ['*.spock.replit.dev', '*.replit.dev', '*.picard.replit.dev', '*.repl.co', '*'],
