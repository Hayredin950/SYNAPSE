"""Widen Article.embedding to vector(1024).
...
(e.g. "articles_article") while the model defines a custom db_table, so the
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("articles", "0008_remove_article_user_userarticle"),
    ]
