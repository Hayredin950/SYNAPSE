...
def _resolve_summarizer_provider(
    ...
    Priority:
      Replit AI (built-in, no user key needed) → Groq → Vercel AI Gateway → legacy.
    """
    ...
    if override_key:
        return (
            ...
            os.environ.get("OPENROUTER_MODEL", "gpt-4o-mini"),
        )
    ...
    # 1. Groq — fastest external option
    ...
    if gateway_key:
        return (
            ...
            os.environ.get("AI_GATEWAY_MODEL", "gpt-4o-mini"),
        )
