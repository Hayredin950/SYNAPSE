"""Widen ResearchPaper.embedding to vector(1024).
...
(e.g. "researchpapers_researchpaper") while the model defines a custom db_table, so the
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("papers", "0008_remove_researchpaper_user_userpaper"),
    ]
