"""Widen Repository.embedding to vector(1024).
...
(e.g. "repositorys_repository") while the model defines a custom db_table, so the
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("repositories", "0009_remove_repository_user_userrepository"),
    ]
